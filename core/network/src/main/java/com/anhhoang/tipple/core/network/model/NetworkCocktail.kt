package com.anhhoang.tipple.core.network.model

import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

/** DAO object for the TheCocktailDB API. */
@Serializable
data class NetworkCocktail(
    @SerialName("idDrink") val id: Int,
    @SerialName("strDrink") val name: String,
    @SerialName("strCategory") val category: String,
    @SerialName("strIBA") val generation: String?,
    @SerialName("strAlcoholic") val type: String,
